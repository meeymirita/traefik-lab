...
> **24.09.2026 — методичка вычитана и исправлена.** Что найдено и что поправлено — в [fixes/traefik.md](https://github.com/meeymirita/submodule-group-lab/blob/main/fixes/traefik.md) сборного репозитория.
