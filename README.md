...
> **24.09.2026 — методичка вычитана и исправлена.** Что найдено и что поправлено — в [fixes/traefik.md](https://github.com/meeymirita/lab-fixes/blob/main/traefik.md) репозитория `lab-fixes`.
